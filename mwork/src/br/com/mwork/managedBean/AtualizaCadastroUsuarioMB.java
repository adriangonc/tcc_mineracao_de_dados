...
@ManagedBean
@ViewScoped
public class AtualizaCadastroUsuarioMB implements Serializable {

	private static final long serialVersionUID = 8508538141870979613L;
	...
	public void buscaInformacoesUsuario() {
		usuario = cadastroUsuarioRN.buscarUsuario(username);
		informacoesUsuarioSistema = cadastroUsuarioRN.buscarInformacoesUsuario(usuario.getId());
	...
	public void atualizarUsuario(){
		...
		try {
			cadastroUsuarioRN.atualizarUsuario(usuario, informacoesUsuarioSistema);
			addMessage(ValorFixo.MSG_REGISTRO_ALTERADO);
		} catch (Exception e) {
			addMessageErro(ValorFixo.MSG_ERRO_SALVAR);
		}
	}
	...
	public void buscarCadastroUsuarioSistema() {
